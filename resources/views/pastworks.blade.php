...
<body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="#2a2b3f" class="">
    <!-- start cursor -->
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown simple-dropdown">
                                <a href="index1.html" class="nav-link">首頁</a>
                            </li>
                            ...
                            <li class="nav-item dropdown simple-dropdown">
                                <a href="product-service.html" class="nav-link">產品/服務</a>
                                <i class="fa-solid fa-angle-down dropdown-toggle" id="navbarDropdownMenuLink3"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                                    <li><a href="index1.html">Shop.com夥伴商店串接</a></li>
                                    <li><a href="index1.html">線上購物平台</a></li>
                                    <li><a href="index1.html">人事差勤管理系統</a></li>
                                    <li><a href="index1.html">財務報銷系統</a></li>
                                    <li><a href="index1.html">教育業管理系統</a></li>
                                    <li><a href="index1.html">訂位／候位系統</a></li>
                                    <li><a href="index1.html">客服系統</a></li>
                                    <li><a href="index1.html">文件管理系統</a></li>
                                    <li><a href="index1.html">網頁小遊戲訂製</a></li>
                                    <li><a href="index1.html">會員註冊及積分統計系統</a></li>
                                    <li><a href="index1.html">問卷調查及數據統計系統</a></li>  
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown submenu">
                                <a href="pastworks.html" class="nav-link">過往作品</a>
                            </li>
                            <li class="nav-item dropdown simple-dropdown">
    ...
    <section
        ...
        style="background-image: url(images/background-wallpaper.jpg); margin-top: inherit;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 filter-content">
                    <ul
                        class="portfolio-boxed portfolio-wrapper grid-loading grid grid-3col grid-3col xxl-grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large text-center">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                    <div class="text-dark-gray fs-28 alt-font fw-500">1M+ property ready to <span
                            class="fw-700 text-decoration-line-bottom">buying and selling.</span></div>
                    <div
                        class="bg-white border-radius-50px d-flex align-items-center p-10px ps-35px ms-20px md-ps-20px md-ms-15px box-shadow-medium sm-m-20px">
                        <a href="demo-real-estate-contact.html"
                            class="text-dark-gray fs-22 alt-font fw-500 me-10px overflow-hidden">Say, <span
                                class="fw-700 w-65px text-start d-inline-block"
                                data-fancy-text='{ "effect": "rotate", "string": ["Hello!", "Salve!", "Hallå!"] }'></span></a>
                        <span
                            class="text-dark-gray h-45px w-45px text-center d-flex align-items-center justify-content-center border-radius-100 bg-base-color-transparent fs-20">&#128075;</span>
                    </div>
                </div>
                <!-- end footer column -->
            </div>
            <div class="row justify-content-center mt-5 mb-4 sm-mb-35px">
                ...
                <div class="col-lg-3 last-paragraph-no-margin md-mb-35px text-center text-lg-start">
                    <a href="index1.html" class="footer-logo mb-10px d-inline-block"><img
                            style="width: 160px !important;max-height: 60px !important;" src="images/logo2.png"
                            data-at2x="images/logo2.png" alt=""></a>
                ...
                <div class="col-8 col-lg-2 col-md-3 sm-mb-25px">
                    ...
                    <ul>
                        ...
                        <li><a href="product-service.html">產品/服務</a></li>
                ...
                <div class="col-6 col-lg-3 col-md-3">
                    ...
                    <a href="mailto:info@domain.com"
                        class="text-dark-gray text-decoration-line-bottom lh-22 d-inline-block mb-20px">quartetsolutions.com.hk</a>
